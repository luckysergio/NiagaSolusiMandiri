...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      color: "hover:text-white hover:bg-slate-700/50 hover:border-slate-600",
      icon: (
    ...
    {
      name: "YouTube",
      url: "https://youtube.com/@nsmreadymixconcretepump",
    ...
    {
      name: "Google Maps",
      url: "https://www.google.com/maps/place/Rental+Pompa+Beton+dan+Jual+Beton+Readymix+%26+Minimix/@-6.3163019,106.6760241,17z",
      color:
        "hover:text-green-400 hover:bg-green-500/10 hover:border-green-500/30",
      icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center gap-3">
              <div
                className="w-1 h-10 bg-indigo-500 rounded-full"
                aria-hidden="true"
              />
              <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Penyedia jasa sewa pompa beton dan supplier beton cor profesional
              & terpercaya di Tangerang dan sekitarnya. Berpengalaman lebih dari
              10 tahun.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4 relative inline-block">
              Tautan Cepat
              <span
                className="absolute -bottom-2 left-0 w-8 h-0.5 bg-indigo-500 rounded-full"
                aria-hidden="true"
              />
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  ...
                  >
                    <span
                      className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-indigo-500 transition-colors"
                      aria-hidden="true"
                    />
                    {link.name}
                  </button>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a
                  href="tel:+6281315913559"
                  className="text-slate-400 hover:text-white transition flex items-center gap-2"
                >
                  <span aria-hidden="true">📞</span> Ade SE: +62 813 1591 3559
                </a>
              </li>
              <li>
                <a
                  href="tel:+6285780679887"
                  className="text-slate-400 hover:text-white transition flex items-center gap-2"
                >
                  <span aria-hidden="true">📞</span> Zulfikar: +62 857 8067 9887
                </a>
              </li>
              <li>
                <a
                  href="mailto:adminwebsitensm@gmail.com"
                  className="text-slate-400 hover:text-white transition flex items-center gap-2"
                >
                  <span aria-hidden="true">✉️</span> adminwebsitensm@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                aria-label={`Kunjungi ${social.name} Niaga Solusi Mandiri`}
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
