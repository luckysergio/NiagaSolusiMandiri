...
export default function SEO({
  ...
  description = "Supplier beton cor terdekat di Tangerang & Tangerang Selatan. Jual readymix mutu SNI, sewa pompa beton, dan finishing trowel. Harga termurah, armada lengkap, siap kirim 24/7.",
  canonicalUrl,
  ogImage,
  ogType = "website",
  publishedTime,
  ...
  const fullTitle = title.includes("Beton Cor Tangerang")
    ? title
    : `${title} | Beton Cor Tangerang`;
  ...
  const isHomePage =
    finalCanonical === siteUrl || finalCanonical === `${siteUrl}/`;
  ...
  const localBusinessSchema = isHomePage
    ? {
        ...
        description:
          "Supplier beton cor terdekat di Tangerang. Melayani jual beton readymix, sewa pompa beton, dan jasa finishing trowel dengan mutu SNI dan harga kompetitif.",
        url: siteUrl,
        logo: fullImageUrl,
        image: fullImageUrl,
        ...
        makesOffer: [
          ...
          },
          {
            ...
            itemOffered: {
              "@type": "Service",
              name: "Sewa Pompa Beton Terdekat",
            },
          },
          {
            "@type": "Offer",
  ...
  return (
    <Helmet>
      ...
      <meta
        name="keywords"
        content="beton cor tangerang, beton cor terdekat, jual beton readymix tangerang, sewa pompa beton tangerang, harga beton cor tangerang, jasa finishing trowel tangerang selatan, niaga solusi mandiri"
      />
      ...
      <meta
        ...
        content="Beton Cor Tangerang - Niaga Solusi Mandiri"
      />
