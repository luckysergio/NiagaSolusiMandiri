    ...
    <Layout>
      ...
      <main className="overflow-x-hidden">
        ...
        >
          ...
          {/* Scroll Indicator */}
          <div
            className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 z-30 animate-bounce hidden sm:block"
            aria-hidden="true"
          >
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto bg-slate-800 rounded-xl sm:rounded-2xl flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-indigo-600 group-hover:scale-110 transition-all duration-300 border border-slate-700 group-hover:border-indigo-500">
                        <Icon
                          className="w-6 h-6 sm:w-7 sm:h-7 text-indigo-400 group-hover:text-white transition-colors"
                          aria-hidden="true"
                        />
                      </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                ...
                yang membuat proyek Anda berjalan lebih efisien dari segala
                aspek.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div data-aos="fade-right">
                ...
                <div className="space-y-3 sm:space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base lg:text-lg">
                  ...
                  <p>
                    Berkomitmen untuk mendukung kesuksesan proyek konstruksi
                    Anda dengan armada modern, operator profesional, dan
                    pelayanan terbaik yang mengedepankan prinsip{" "}
        ...
        <section id="services" className="py-16 sm:py-24 px-4 bg-slate-900">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Berbagai keunggulan yang membuat kami menjadi pilihan tepat
                untuk efisiensi proyek Anda
              </p>
            </div>
