...
export default function About() {
  ...
  // ✅ OPTIMASI AOS: Inisialisasi sekali dan refresh setelah window load untuk mencegah layout shift
  useEffect(() => {
    AOS.init({
      duration: 800,
      once: true,
  ...
  const serviceAreas = [
    {
      ...
      areas: [
        "BSD City", "Alam Sutera", "Gading Serpong", "Bintaro Jaya", 
        "Pondok Aren", "Ciputat", "Pamulang", "Serpong", "Cisauk",
      ],
    },
    {
      region: "Tangerang Selatan",
      areas: [
        "BSD", "Bintaro", "Pondok Aren", "Ciputat Timur", 
        "Pamulang Barat", "Serpong Utara", "Setu", "Jurang Mangu",
      ],
    },
  ];
  ...
  return (
    <Layout>
      ...
      <main className="overflow-x-hidden">
        ...
        <section id="about" className="py-16 sm:py-24 px-4 bg-slate-950 border-y border-slate-800">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div data-aos="fade-left" className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  ...
                  >
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 ${item.bg} rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}>
