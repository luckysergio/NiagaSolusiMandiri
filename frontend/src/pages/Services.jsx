...
export default function Services() {
  ...
  const services = [
    {
      ...
      description:
        "Beton cor siap pakai untuk berbagai kebutuhan konstruksi. Tersedia pilihan mutu dari K125 hingga K500 sesuai spesifikasi proyek Anda.",
      features: [
    ...
    },
    {
      ...
      description:
        "Menyewakan pompa beton dengan berbagai ukuran untuk memudahkan proses pengecoran di lokasi proyek Anda.",
      features: [
    ...
    },
    {
      ...
      description:
        "Jasa finishing lantai beton untuk menghasilkan permukaan yang rata, halus, dan siap pakai dengan kualitas premium.",
      features: [
  ...
  const advantages = [
    {
      ...
      desc: "Menyesuaikan jadwal sesuai kebutuhan proyek Anda",
      gradient: "from-blue-600 to-cyan-600",
    },
    {
      icon: MapPin,
      title: "Jangkauan Luas",
      desc: "Melayani Tangerang Raya dan sekitarnya",
      gradient: "from-emerald-600 to-teal-600",
    },
    {
      icon: Users,
      title: "Tim Berpengalaman",
      desc: "Tenaga profesional yang mengerti kebutuhan konstruksi",
      gradient: "from-purple-600 to-pink-600",
    },
    {
      icon: Shield,
      title: "Kualitas Terjaga",
      desc: "Material dan peralatan dalam kondisi prima",
      gradient: "from-amber-600 to-orange-600",
    },
    {
      icon: Award,
      title: "Harga Bersaing",
      desc: "Penawaran terbaik dengan kualitas premium",
      gradient: "from-rose-600 to-red-600",
    },
    {
      icon: Phone,
      title: "Konsultasi Mudah",
      desc: "Tim marketing siap membantu 24/7",
  ...
  const faqs = [
    {
      q: "Apakah melayani proyek skala kecil?",
      a: "Ya, kami melayani proyek dari skala kecil hingga besar. Bahkan untuk volume di bawah 5 m³ pun tetap kami layani dengan harga kompetitif.",
    },
    {
      q: "Berapa lama waktu respon?",
      a: "Tim marketing kami biasanya merespon dalam waktu kurang dari 10 menit di jam kerja. Untuk konsultasi di luar jam kerja, akan direspon keesokan harinya.",
    },
    {
      q: "Apakah bisa survey lokasi terlebih dahulu?",
      a: "Tentu, tim kami dapat melakukan survey lokasi untuk memberikan rekomendasi yang tepat sesuai kondisi proyek Anda. Survey gratis tanpa biaya.",
    },
    {
      q: "Apakah ada biaya konsultasi?",
      a: "Konsultasi awal kami berikan gratis. Anda bisa diskusi terlebih dahulu tanpa ada kewajiban apapun.",
    },
  ];
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            <img
              ...
              alt={`Layanan konstruksi Niaga Solusi Mandiri ${currentImageIndex + 1}`}
          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
              ...
              >
                Tiga layanan utama untuk mendukung kelancaran proyek konstruksi
                Anda. Mulai dari penyediaan beton, sewa pompa, hingga finishing
                lantai.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Menggabungkan supply beton, pompa, dan finishing dalam satu atap
                memberikan efisiensi maksimal untuk proyek Anda.
              </p>
            </div>
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-900">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Pilih layanan yang sesuai dengan kebutuhan spesifik proyek Anda
              </p>
            </div>
              ...
              {services.map((service, idx) => {
                ...
                return (
                  <div
                    ...
                    className="group bg-slate-800/40 backdrop-blur-sm rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500 hover:-translate-y-2 border border-slate-700/50 hover:border-indigo-500/40 flex flex-col"
                  >
                    <div className="p-6 sm:p-8 border-b border-slate-700/50 text-center flex-1">
                      <div
                        className={`w-14 h-14 sm:w-16 sm:h-16 mx-auto bg-linear-to-br ${service.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg`}
                      >
                        <Icon
                    ...
                    <div className="p-6 sm:p-8 bg-slate-800/60">
                      ...
                      <Link
                        to={service.path}
                        className="inline-flex items-center justify-center gap-2 w-full py-3 bg-slate-700/50 hover:bg-indigo-600 text-white font-semibold rounded-xl transition-all duration-300 border border-slate-600 hover:border-indigo-500 group-hover:shadow-lg group-hover:shadow-indigo-500/25"
                      >
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-950 border-y border-slate-800">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Alasan pelanggan mempercayakan proyek mereka kepada kami
              </p>
            </div>
              ...
              {advantages.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    data-aos="fade-up"
                    data-aos-delay={idx * 100}
                    className="flex gap-4 p-5 sm:p-6 bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-800 hover:border-indigo-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5"
                  >
                    <div
                      className={`w-12 h-12 shrink-0 bg-linear-to-br ${item.gradient} rounded-xl flex items-center justify-center shadow-md`}
                    >
                      <Icon className="w-6 h-6 text-white" aria-hidden="true" />
                    </div>
                    <div>
                      <h3 className="font-bold text-white mb-1 text-base sm:text-lg">
                        {item.title}
                      </h3>
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-900">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Proses kerja sederhana dan transparan untuk kenyamanan Anda
              </p>
            </div>
              ...
              {[
                {
                  step: "01",
                  title: "Konsultasi",
                  desc: "Diskusi kebutuhan dan spesifikasi proyek",
                  icon: MessageCircle,
                },
                {
                  step: "02",
                  title: "Penawaran",
                  desc: "Kami berikan harga dan jadwal pelaksanaan",
                  icon: Target,
                },
                {
                  step: "03",
                  title: "Eksekusi",
                  desc: "Tim kami melakukan pengerjaan sesuai kesepakatan",
                  icon: Zap,
                },
                {
                  step: "04",
                  title: "Serah Terima",
                  desc: "Hasil kerja diperiksa bersama dan diserahkan",
                  icon: Heart,
                },
              ].map((item, idx) => {
                const Icon = item.icon;
                return (
                  <div
                    ...
                    data-aos="fade-up"
                    data-aos-delay={idx * 100}
                    className="text-center group p-4 sm:p-6 rounded-2xl bg-slate-800/30 border border-slate-700/50 hover:border-indigo-500/30 transition-all duration-300"
                  >
                    ...
                    <Icon
                      className="w-5 h-5 sm:w-6 sm:h-6 text-indigo-400 mx-auto mb-2"
                      aria-hidden="true"
                    />
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-950 border-y border-slate-800">
          <div className="max-w-4xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Informasi yang perlu Anda ketahui sebelum menggunakan layanan
                kami
              </p>
            </div>
            <div className="space-y-3 sm:space-y-4">
              {faqs.map((faq, idx) => (
                <div
                  ...
                  className="bg-slate-900/60 backdrop-blur-sm p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-800 hover:border-indigo-500/30 transition-all duration-300"
                >
                  <h3 className="font-bold text-white mb-2 sm:mb-3 text-base sm:text-lg">
                    {faq.q}
                  </h3>
                  <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
                    {faq.a}
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              {serviceAreas.map((region, regionIdx) => (
                <div
                  ...
                  className="bg-slate-950 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-800 hover:border-indigo-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-indigo-500/5"
                >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3">
                    {region.areas.map((area, areaIdx) => (
                      <div
                        key={areaIdx}
                        className="flex items-center gap-2 sm:gap-2.5 p-2.5 sm:p-3 bg-slate-900 rounded-lg sm:rounded-xl border border-slate-800 hover:border-emerald-500/30 hover:bg-slate-800/50 transition-all duration-300"
                      >
                        <CheckCircle
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div data-aos="fade-up">
              ...
              <p className="text-slate-300 text-sm sm:text-base lg:text-lg mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-2">
                ...
                untuk memastikan solusi terbaik bagi proyek Anda.
              </p>
