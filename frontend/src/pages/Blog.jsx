    ...
    <Layout>
      ...
      <main className="w-full min-h-screen">
        ...
        <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            {allImages.length > 0 ? (
              <img
                ...
                alt={`Blog konstruksi Niaga Solusi Mandiri ${currentHeroIndex + 1}`}
          ...
          <div
            className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20"
            data-aos="fade-up"
          ...
          <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <div
                  className="flex-1 h-px bg-linear-to-r from-indigo-500/30 to-transparent ml-4"
                  aria-hidden="true"
                ></div>
              </div>
                    ...
                    <div className="lg:w-3/5 p-6 flex flex-col justify-between">
                      <div>
                        <div className="flex items-center gap-2 text-xs text-slate-400 mb-3 flex-wrap">
                          <span className="px-2.5 py-1 bg-indigo-500/10 text-indigo-300 rounded-md border border-indigo-500/20 font-medium">
                      ...
                      <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-700/50">
                        ...
                        <Link
                          to={`/blog/${post.slug}`}
                          className="text-indigo-300 hover:text-indigo-200 font-semibold flex items-center gap-1.5 text-sm transition-all duration-300 group/link"
                        >
                          Baca Selengkapnya{" "}
                          <ArrowRight
        ...
        <section
          ...
          className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-slate-950 scroll-mt-24"
        >
          <div className="max-w-7xl mx-auto">
            <div
              className="flex items-center gap-3 mb-10"
            ...
            >
              ...
              <div
                className="flex-1 h-px bg-linear-to-r from-slate-700/50 to-transparent ml-4"
                aria-hidden="true"
              ></div>
              <span className="text-sm text-slate-400 font-medium bg-slate-900/50 px-3 py-1 rounded-full border border-slate-800">
            ...
            {loading ? (
              ...
              <div
                className="text-center py-20 bg-slate-900/50 rounded-3xl border border-slate-800"
                data-aos="fade-up"
              >
                ...
                <p className="text-slate-400 max-w-md mx-auto">
                  Belum ada artikel dalam kategori ini. Silakan pilih kategori
                  lain.
                </p>
              </div>
            ) : (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {posts.map((post, idx) => (
                  ...
                  >
                    <Link
                      to={`/blog/${post.slug}`}
                      className="block relative h-48 overflow-hidden bg-slate-800"
                    >
                      {post.image ? (
                        <img
                          src={post.image}
            ...
            {!loading && totalPages > 1 && (
              <nav
                className="flex items-center justify-center gap-2 sm:gap-3 mt-12 pt-8 border-t border-slate-800"
                data-aos="fade-up"
