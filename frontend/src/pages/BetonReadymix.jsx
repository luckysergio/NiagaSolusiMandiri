...
export default function BetonReadymix() {
  ...
  const keunggulan = [
    {
      icon: Shield,
      title: "Kualitas Standar SNI",
      desc: "Material terjamin sesuai spesifikasi teknis",
      gradient: "from-blue-600 to-cyan-600",
    },
    {
      icon: Truck,
      title: "Pengiriman Tepat Waktu",
      desc: "Armada terawat dan jadwal yang presisi",
      gradient: "from-emerald-600 to-teal-600",
    },
    {
      icon: TrendingUp,
      title: "Mutu Lengkap",
      desc: "Tersedia dari K125 hingga K500",
      gradient: "from-purple-600 to-pink-600",
    },
    {
      icon: Zap,
      title: "Pengerjaan Cepat",
      desc: "Didukung tim profesional berpengalaman",
      gradient: "from-amber-600 to-orange-600",
    },
    {
      icon: Award,
      title: "Harga Kompetitif",
      desc: "Transparan, bersaing, dan tanpa biaya tersembunyi",
      gradient: "from-rose-600 to-red-600",
    },
    {
      icon: Clock,
      title: "Konsultasi Gratis",
      desc: "Layanan teknis dan estimasi volume tanpa biaya",
  ...
  return (
    <Layout>
      <SEO
        title="Jual Beton Cor Readymix Tangerang | Harga & Mutu K125-K500"
        description="Daftar harga beton cor readymix berbagai mutu K125 hingga K500 di Tangerang & Tangerang Selatan. Hemat Waktu, Hemat Biaya, Hemat Tenaga. Mutu SNI, armada minimix & standar lengkap."
        canonicalUrl="https://betoncortangerang.com/layanan/beton-readymix"
      />
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            <img
              ...
              alt={`Beton cor readymix Niaga Solusi Mandiri ${currentImageIndex + 1}`}
          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
              ...
              >
                Kami menyediakan beton cor readymix berkualitas tinggi dengan
                berbagai pilihan mutu sesuai kebutuhan proyek konstruksi Anda di
          ...
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Beralih ke beton readymix adalah keputusan strategis untuk
          ...
          <div className="max-w-5xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12">
              ...
              <p className="text-slate-400 text-sm sm:text-base">
                Harga per meter kubik (m³) - Belum termasuk PPN
              </p>
            </div>
            <div
              data-aos="fade-up"
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-950 border-y border-slate-800">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-extrabold text-white mb-4 tracking-tight">
                Keunggulan Beton Readymix Kami
              </h2>
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Berbagai keunggulan yang membuat beton readymix kami menjadi
                pilihan tepat
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div data-aos="fade-right">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-6 tracking-tight">
                  Aplikasi Beton Readymix
                </h2>
                <p className="text-slate-300 mb-8 text-sm sm:text-base leading-relaxed">
                  Beton readymix kami cocok digunakan untuk berbagai jenis
                  proyek konstruksi, dari skala kecil hingga besar.
                </p>
              ...
              <div data-aos="fade-left" className="space-y-6">
                <div className="bg-slate-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-700/50 text-center">
                  ...
                  <p className="text-slate-400 text-sm sm:text-base mb-6 leading-relaxed">
                    Dilengkapi dengan armada minimix dan standar yang selalu
                    dalam kondisi prima.
                  </p>
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div data-aos="fade-up">
              ...
              <p className="text-slate-300 text-sm sm:text-base lg:text-lg mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-2">
                Hubungi tim marketing kami untuk mendapatkan penawaran terbaik,
                estimasi volume, dan konsultasi gratis untuk proyek Anda.
              </p>
