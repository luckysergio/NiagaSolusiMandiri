...
export default function Login() {
  ...
  const { isLoaded, isExecuting, triggerLoad, getToken } = useReCaptcha();
  ...
  const isBusy = isSubmitting || isExecuting || loading;
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (!recaptchaToken) {
        ...
        showError(
          "Login Gagal",
          "Gagal mendapatkan token reCAPTCHA. Silakan coba lagi.",
        );
        return;
      }
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          <div className="hidden lg:block space-y-8 animate-fadeIn">
            <div className="text-left">
              ...
              <p className="text-slate-300 text-base xl:text-lg leading-relaxed mb-8">
                Supplier beton cor dan penyedia jasa sewa pompa beton
                berpengalaman lebih dari 10 tahun di industri konstruksi
                Indonesia. Melayani wilayah Tangerang Raya dan sekitarnya.
              </p>
          ...
          <div className="w-full max-w-md mx-auto animate-scaleIn">
            ...
            <div className="bg-slate-800/50 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-700/50 p-6 sm:p-8">
              ...
              {/* reCAPTCHA Status */}
              <div
                className={`mb-5 px-3 py-2 rounded-xl text-xs flex items-center justify-center gap-2 transition-all duration-500 ${
                  isLoaded
              ...
              >
                <span
                  className={`inline-block w-2 h-2 rounded-full ${
                    isLoaded ? "bg-emerald-400" : "bg-amber-400 animate-pulse"
                  }`}
                  aria-hidden="true"
                ></span>
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      {...register("email")}
                      onFocus={triggerLoad}
                      className={`block w-full pl-10 pr-3 py-2.5 sm:py-3 bg-slate-700/50 border rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-200 text-sm sm:text-base ${
                        errors.email
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      {...register("password")}
                      onFocus={triggerLoad}
                      className={`block w-full pl-10 pr-12 py-2.5 sm:py-3 bg-slate-700/50 border rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-200 text-sm sm:text-base ${
                        errors.password
                          ? "border-red-500 focus:ring-red-500/20 focus:border-red-500"
                          : "border-slate-600 focus:ring-indigo-500/20 focus:border-indigo-500"
                      }`}
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-300 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/20 rounded-r-xl"
                      aria-label={
                        showPassword
                ...
                <button
                  ...
                  className={`w-full py-2.5 sm:py-3 px-4 rounded-xl font-medium text-white transition-all duration-200 flex items-center justify-center gap-2 group relative overflow-hidden text-sm sm:text-base ${
                    isBusy || !isLoaded
                ...
                >
                  <div
                    className={`absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent -skew-x-12 transition-transform duration-700 ${
                      isHovered && !isBusy && isLoaded
                        ? "translate-x-full"
                        : "-translate-x-full"
                    }`}
                    aria-hidden="true"
                  ...
                  {isBusy ? (
                    <>
                      ...
                      <span>
                        {isExecuting ? "Verifikasi..." : "Memproses..."}
                      </span>
                    </>
                  ) : (
                    <>
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-3 gap-2 sm:gap-3">
              {STATS.map((stat, index) => (
                <div
                  key={index}
                  className="text-center p-2 sm:p-3 bg-slate-800/30 rounded-lg backdrop-blur-sm border border-slate-700/30"
                >
