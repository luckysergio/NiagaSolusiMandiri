  ...
  const services = [
    {
      ...
      description:
        "Beton cor siap pakai dengan mutu K-125 hingga K-500 untuk pondasi gedung, jalan raya, jembatan, dan infrastruktur lainnya.",
      features: [
    ...
    },
    {
      ...
      description:
        "Pompa beton untuk memindahkan beton cair ke lokasi pengecoran yang sulit dijangkau. Cocok untuk proyek bertingkat dan area dengan akses terbatas.",
      features: [
        "Pompa Mini (12-30m)",
    ...
    },
    {
      ...
      images: trowelImages,
      description:
        "Menghaluskan permukaan lantai beton menggunakan mesin khusus, menghasilkan lantai rata, halus, anti slip, dan tahan lama.",
      features: [
  ...
  const testimonials = [
    {
      ...
      text: "Pelayanan sangat profesional dan tepat waktu. Beton readymix berkualitas tinggi, hasil cor sangat memuaskan.",
      rating: 5,
    },
    {
      id: 2,
      ...
      text: "Sewa pompa beton sangat membantu proyek kami. Akses ke area pabrik yang sempit tidak masalah dengan pompa mini mereka.",
      rating: 5,
    },
    {
      id: 3,
      ...
      text: "Kombinasi beton readymix dan finishing trowel menghasilkan lantai yang sangat rata dan halus. Harga kompetitif.",
      rating: 5,
    },
    {
      id: 4,
      ...
      text: "Layanan finishing trowel sangat memuaskan. Lantai gudang menjadi rata, anti slip, dan tahan lama.",
      rating: 5,
    },
  ];
  ...
  const renderServiceCard = (service, idx) => {
    ...
    return (
      <div
        ...
        className="group bg-slate-900 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500 overflow-hidden border border-slate-800 hover:border-indigo-500/50 hover:-translate-y-2 relative"
      >
        <div
          className={`absolute top-0 left-0 right-0 h-1 bg-linear-to-r ${service.gradient}`}
        ></div>
        ...
        <div className="relative h-56 overflow-hidden bg-slate-800">
          {service.images.map((img, imgIdx) => (
            <div
              key={imgIdx}
              className={`absolute inset-0 transition-opacity duration-700 ease-in-out ${imgIdx === currentIndex ? "opacity-100" : "opacity-0"}`}
            >
              <img
                src={img}
    ...
    <div className="overflow-x-hidden">
      <Layout>
        ...
        <main>
          ...
          <section id="services" className="py-24 px-4 bg-slate-950 relative">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                >
                  Kami menghadirkan efisiensi maksimal dengan prinsip{" "}
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div data-aos="fade-right">
                  ...
                  <p className="text-slate-300 mb-8 text-lg leading-relaxed">
                    Kami tidak hanya menyediakan material, tetapi juga
                    memberikan solusi yang membuat proyek Anda berjalan lebih
                    efisien dari segala aspek.
                  </p>
                    ...
                    {[
                      {
                        icon: Timer,
                        title: "Hemat Waktu",
                        desc: "Jadwal pengiriman presisi dan armada siap pakai memastikan proyek Anda tidak terhambat.",
                      },
                      {
                        icon: Wallet,
                        title: "Hemat Biaya",
                        desc: "Harga kompetitif langsung dari supplier, tanpa perantara, dengan kualitas mutu terjamin.",
                      },
                      {
                        icon: HandMetal,
                        title: "Hemat Tenaga",
                        desc: "Didukung operator profesional dan mesin modern, mengurangi beban kerja manual di lapangan.",
                      },
                    ].map((item, idx) => {
                      const Icon = item.icon;
                      return (
                    ...
                    {testimonials.map((testimonial) => (
                      ...
                      >
                        <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800 shadow-xl relative">
                          <Quote
                            className="absolute top-6 right-6 w-12 h-12 text-slate-800"
                            aria-hidden="true"
                          />
          ...
          <section
            id="service-area"
            className="py-24 px-4 bg-slate-900 border-y border-slate-800"
          >
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <div
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    ...
                    className="bg-slate-950 rounded-2xl p-8 border border-slate-800 hover:border-indigo-500/30 transition-all duration-500 hover:shadow-lg hover:shadow-indigo-500/5"
                  >
              ...
              <div className="space-y-4">
                {faqData.map((faq, idx) => (
                  <div
                    ...
                    data-aos="fade-up"
                    data-aos-delay={idx * 100}
                    className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden hover:border-indigo-500/30 transition-all duration-300"
                  >
                    <button
                    ...
                    {openFaq === idx && (
                      ...
                      >
                        <p className="text-slate-400 border-t border-slate-800 pt-4 leading-relaxed">
                          {faq.answer}
                        </p>
                      </div>
                    )}
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                <div data-aos="fade-right">
                  ...
                  <p className="text-slate-300 text-lg mb-10 leading-relaxed">
                    Hubungi tim marketing kami untuk konsultasi gratis dan
                    penawaran terbaik. Kami siap mewujudkan{" "}
                    <span className="text-emerald-400 font-semibold">
                      Hemat Waktu, Hemat Biaya, Hemat Tenaga
                    </span>{" "}
                    untuk proyek Anda.
                ...
                <div
                  data-aos="fade-left"
                  className="bg-slate-900 rounded-3xl shadow-2xl p-8 border border-slate-800"
                >
                  ...
                  <form className="space-y-5" onSubmit={handleContactSubmit}>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleFormChange}
                        required
                        className="w-full px-4 py-3.5 bg-slate-950 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition text-white placeholder-slate-400 resize-none"
