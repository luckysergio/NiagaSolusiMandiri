...
export default function PompaBeton() {
  ...
  const hargaPompa = [
    {
      volume: "5 m³ s/d 25 m³",
      standar: "Rp 4.000.000",
      longboom: "Rp 5.000.000",
      superLongboom: "Rp 7.500.000",
    },
    {
      volume: "26 m³ s/d 50 m³",
      standar: "Rp 4.200.000",
      longboom: "Rp 5.250.000",
      superLongboom: "Rp 7.750.000",
    },
    {
      volume: "51 m³ s/d 75 m³",
      standar: "Rp 4.400.000",
      longboom: "Rp 5.500.000",
      superLongboom: "Rp 8.000.000",
    },
    {
      volume: "76 m³ s/d 100 m³",
      standar: "Rp 4.600.000",
      longboom: "Rp 5.750.000",
      superLongboom: "Rp 8.250.000",
    },
  ];

  const hargaPerM3 = [
    {
      volume: "Di atas 100 m³",
      standar: "Rp 45.000/m³",
      longboom: "Rp 60.000/m³",
      superLongboom: "Rp 85.000/m³",
    },
  ];

  const jenisPompa = [
    {
      name: "Pompa Standar / Mini",
      icon: Truck,
      desc: "Cocok untuk proyek dengan akses terbatas",
      jangkauan: "30-40 meter",
      gradient: "from-blue-600 to-cyan-600",
    },
    {
      name: "Pompa Longboom",
      icon: Ruler,
      desc: "Jangkauan lebih jauh untuk proyek besar",
      jangkauan: "47-50 meter",
      gradient: "from-purple-600 to-pink-600",
    },
    {
      name: "Pompa Super Longboom",
      icon: Gauge,
      desc: "Untuk proyek dengan jangkauan ekstra",
      jangkauan: "50+ meter",
  ...
  const keunggulan = [
    {
      ...
      desc: "Tim tersertifikasi dan profesional",
      gradient: "from-blue-600 to-cyan-600",
    },
    {
      icon: Shield,
      title: "Unit Terawat",
      desc: "Pompa dalam kondisi prima",
      gradient: "from-emerald-600 to-teal-600",
    },
    {
      icon: Clock,
      title: "Mobilisasi Cepat",
      desc: "Tepat waktu sesuai jadwal",
      gradient: "from-purple-600 to-pink-600",
    },
    {
      icon: Zap,
      title: "Harga Kompetitif",
      desc: "Sewa dengan harga terbaik",
  ...
  return (
    <Layout>
      <SEO
        title="Sewa Pompa Beton Tangerang | Harga & Jenis Pompa Mini/Longboom"
        description="Daftar harga sewa pompa beton berbagai jenis: Standar, Longboom, Super Longboom. Hemat Waktu, Hemat Biaya, Hemat Tenaga. Layanan 24 jam di Tangerang & Tangerang Selatan."
        canonicalUrl="https://betoncortangerang.com/layanan/pompa-beton"
      />
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            <img
              ...
              alt={`Sewa pompa beton Niaga Solusi Mandiri ${currentImageIndex + 1}`}
          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
              ...
              >
                <Truck className="w-4 h-4 text-indigo-400" aria-hidden="true" />
              ...
              >
                Menyewakan berbagai jenis pompa beton dengan operator
                berpengalaman untuk kelancaran dan efisiensi proyek pengecoran
                Anda di Tangerang dan sekitarnya.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Memilih layanan sewa pompa beton kami adalah keputusan strategis
                untuk efisiensi proyek Anda dari segala aspek.
              </p>
            </div>
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-900">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Pilih armada yang sesuai dengan kebutuhan dan skala proyek Anda
              </p>
            </div>
              ...
              {jenisPompa.map((pompa, idx) => {
                ...
                return (
                  <div
                    ...
                    className="group bg-slate-800/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-slate-700/50 hover:border-indigo-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-indigo-500/5 text-center"
                  >
                    <div
                      className={`w-12 h-12 sm:w-14 sm:h-14 mx-auto bg-linear-to-br ${pompa.gradient} rounded-xl flex items-center justify-center mb-4 sm:mb-5 group-hover:scale-110 transition-transform shadow-lg`}
                    >
                      <Icon
                    ...
                    <p className="text-indigo-300 font-bold text-sm sm:text-base">
                      Jangkauan: {pompa.jangkauan}
                    </p>
                  </div>
                );
              })}
          ...
          <div className="max-w-5xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12">
              ...
              <p className="text-slate-400 text-sm sm:text-base">
                Harga sewa per 8 jam (termasuk 1 kali mobilisasi)
              </p>
            </div>
            <div
              data-aos="fade-up"
              ...
              <table className="min-w-full border-collapse">
                ...
                <tbody>
                  ...
                  {hargaPerM3.map((item, idx) => (
                    <tr
                      key={`m3-${idx}`}
                      className="bg-indigo-500/10 border-t-2 border-indigo-500/30"
                    >
                      <td className="py-3 sm:py-4 px-4 sm:px-6 text-center font-bold text-white text-sm sm:text-base">
                        {item.volume}
                      </td>
                      <td className="py-3 sm:py-4 px-4 sm:px-6 text-center text-indigo-300 text-sm sm:text-base font-bold">
                        {item.standar}
                      </td>
                      <td className="py-3 sm:py-4 px-4 sm:px-6 text-center text-indigo-300 text-sm sm:text-base font-bold">
                        {item.longboom}
        ...
        <section className="py-16 sm:py-24 px-4 bg-slate-900 border-y border-slate-800">
          <div className="max-w-7xl mx-auto">
            <div data-aos="fade-up" className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Berbagai keunggulan yang membuat layanan sewa pompa kami menjadi
                pilihan utama
              </p>
            </div>
              ...
              {keunggulan.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    data-aos="fade-up"
                    data-aos-delay={idx * 100}
                    className="group bg-slate-800/30 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-slate-700/50 hover:border-indigo-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-indigo-500/5 text-center"
                  >
                    <div
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    <div
                      ...
                      data-aos="zoom-in"
                      data-aos-delay={idx * 100}
                      className="bg-slate-900/50 backdrop-blur-sm p-4 rounded-xl text-center border border-slate-800 hover:border-indigo-500/30 transition-all"
                    >
              ...
              <div data-aos="fade-left" className="text-center lg:text-left">
                ...
                <p className="text-slate-400 mb-6 text-sm sm:text-base leading-relaxed">
                  Kami melayani berbagai perumahan dan kawasan di wilayah
                  Tangerang dan sekitarnya dengan respon cepat.
                </p>
                <div className="flex flex-wrap gap-2 mb-6 justify-center lg:justify-start">
                  {[
                    ...
                    <span
                      key={idx}
                      className="px-3 py-1.5 bg-slate-800/50 text-slate-300 rounded-lg text-sm border border-slate-700/50 hover:border-indigo-500/30 hover:bg-slate-800 transition-all"
                    >
                      {city}
                    </span>
                  ))}
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div data-aos="fade-up">
              ...
              <p className="text-slate-300 text-sm sm:text-base lg:text-lg mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-2">
                Hubungi tim marketing kami untuk konsultasi kebutuhan armada,
                estimasi volume, dan penawaran harga terbaik untuk proyek Anda.
              </p>
