...
export default function Contact() {
  ...
  const handleWhatsApp = (contact, type, data = {}) => {
    ...
    if (type === "order") {
      message =
        `Halo ${contact.name}, saya ingin memesan beton cor untuk proyek saya.%0A%0A` +
        `Detail Pemesanan:%0A` +
      ...
      message =
        `Halo ${contact.name}, saya ingin konsultasi tentang kebutuhan proyek saya.%0A%0A` +
        `Detail Proyek:%0A` +
      ...
      message = `Halo ${contact.name}, saya tertarik dengan layanan Niaga Solusi Mandiri.%0A%0AMohon informasinya lebih lanjut. Terima kasih.`;
    }
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const message =
      `*PESANAN BARU DARI WEBSITE*%0A%0A` +
  ...
  return (
    <Layout>
      ...
      <main className="overflow-x-hidden">
        {/* Hero Section */}
        <section
          className="relative w-full min-h-[60vh] flex items-center justify-center px-4 pt-20 overflow-hidden"
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            <img
              ...
              alt={`Layanan Niaga Solusi Mandiri ${currentImageIndex + 1}`}
          ...
          <div
            className="relative z-10 text-center max-w-4xl mx-auto px-4 py-12"
            data-aos="fade-up"
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed font-light mb-8">
              Hubungi tim marketing kami untuk konsultasi, informasi harga, atau
              pemesanan beton cor dan sewa pompa beton.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16" data-aos="fade-up">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
                Siap membantu Anda dengan pelayanan terbaik dan respon cepat
              </p>
            </div>
              ...
              {contactPersons.map((contact, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-4 mb-6">
                    <div
                      className={`w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-linear-to-br ${contact.gradient} flex items-center justify-center text-4xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      role="img"
                      aria-label={`Avatar ${contact.name}`}
                    >
                      {contact.avatar}
                    </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-700/50">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-2.5 bg-slate-900/50 hover:bg-slate-800 rounded-lg text-xs font-medium text-slate-300 transition-colors flex items-center justify-center gap-1.5 border border-slate-700/50 hover:border-indigo-500/30 active:scale-95"
                      >
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
                    Tim marketing kami siap melayani Anda untuk konsultasi,
                    pemesanan, dan informasi teknis.
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      title: "Alamat",
                      content:
                        "Jl. Masjid Ar Rahman, Rawabuntu, Serpong, Tangerang Selatan",
                      color: "text-indigo-400",
                    },
                    {
                      icon: Mail,
                      title: "Email",
                      content: "adminwebsitensm@gmail.com",
                      action: "mailto:adminwebsitensm@gmail.com",
                      color: "text-indigo-400",
                    },
                    {
                      icon: Clock,
                      title: "Jam Operasional",
                      content: "08:00 - 22:00 (24/7 untuk darurat)",
                      color: "text-indigo-400",
                    },
                  ].map((item, idx) => {
                    const Icon = item.icon;
                    return (
                      <div
                        ...
                        className="flex items-center gap-4 p-5 bg-slate-900/60 backdrop-blur-sm rounded-2xl border border-slate-800 hover:border-indigo-500/30 transition-all duration-300"
                      >
                        ...
                        <div>
                          ...
                          {item.action ? (
                            <a
                              href={item.action}
                              className="text-slate-400 text-sm hover:text-indigo-300 transition-colors break-all"
                            >
                              {item.content}
                            </a>
                          ) : (
                ...
                <div className="bg-slate-900/60 backdrop-blur-sm rounded-3xl border border-slate-800 overflow-hidden shadow-2xl">
                  <div className="bg-linear-to-r from-indigo-600 to-purple-600 px-6 py-5 text-center">
                    ...
                    <p className="text-indigo-100 text-sm mt-1">
                      Isi form berikut, kami akan segera merespon via WhatsApp
                    </p>
                  </div>
                  ...
                  >
                    <div className="grid md:grid-cols-2 gap-5">
                      <div>
                        <label
                          ...
                          className="block text-sm font-semibold text-slate-300 mb-2 text-left"
                        >
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white placeholder-slate-400 transition-all"
                          required
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          name="projectType"
                          className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white transition-all"
                          onChange={handleFormChange}
                        >
                          <option value="">Pilih Tipe Proyek</option>
                          <option value="Beton Cor Readymix">
                            Beton Cor Readymix
                          </option>
                          <option value="Sewa Pompa Beton">
                            Sewa Pompa Beton
                          </option>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows="4"
                        className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white placeholder-slate-400 resize-none transition-all"
                        required
                        onChange={handleFormChange}
                      />
                    </div>
                    ...
                    <p className="text-xs text-slate-400 text-center">
                      Pesan akan dikirim langsung ke tim marketing kami via
                      WhatsApp
                    </p>
                  </form>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div data-aos="fade-up" className="mt-8 sm:mt-12 text-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shadow-indigo-600/25"
              >
                <MessageCircle className="w-5 h-5" aria-hidden="true" />
        ...
        <section
          id="contact"
          className="w-full py-16 sm:py-24 px-4 bg-linear-to-br from-indigo-950 via-slate-950 to-purple-950 relative overflow-hidden"
        >
          <div
            ...
            <div data-aos="fade-up">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg shadow-emerald-600/25"
                >
                  <MessageCircle className="w-5 h-5" aria-hidden="true" />
                  WhatsApp Ade SE
                </a>
